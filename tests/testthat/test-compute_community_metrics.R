...
test_that("missing weights generate a warning and are excluded from biomass sums", {
...
test_that("zero weights generate a warning and are retained in biomass sums", {
